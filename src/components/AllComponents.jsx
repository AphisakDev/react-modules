...
export function FAQ() {
  ...
  const items = [
    { value: "1", title: `Q: What makes XYZ Company's products so unique?`, text: `A: At XYZ Company, we pride ourselves on innovation and cutting-edge
    ...
    { value: "2", title: `Q: How does XYZ Company contribute to sustainability and
            environmental conservation?`, text: `A: XYZ Company is committed to environmental responsibility. We
          ...
          future.` },
    { value: "3", title: `Q: What kind of support can customers expect from XYZ Company's
            customer service team?`, text: `A: At XYZ Company, customer satisfaction is our top priority. Our
    ...
    { value: "4", title: `Q: How does XYZ Company stay ahead of industry trends?`, text: `A: XYZ Company stays at the forefront of industry trends through
    ...
    { value: "5", title: `Q: Can you tell us about XYZ Company's commitment to community
            involvement?`, text: `A: XYZ Company is deeply committed to giving back to the communities
